...
// pingForRTT("161.35.41.62"); // London = Round trip time: 714 ms, anden gang: 183 ms
// pingForRTT("170.64.178.159"); // Sydney = Round trip time: 518 ms, anden gang: 334 ms
// pingForRTT("64.227.111.29"); // San Francisco = Round trip time: 389 ms, anden gang: 729 ms

// pingForAverageRTT("161.35.41.62", 10, 1000); // London = Received message. Average RTT: 50 ms - 179 ms
// pingForAverageRTT("170.64.178.159", 10, 1000); // Sydney = Received message. Average RTT: 403 ms - 629 ms
// pingForAverageRTT("64.227.111.29", 10, 1000); // San Francisco = Received message. Average RTT: 210 ms - 405 ms

pingServersForRTT(HOSTS); // Round trip time: 56 ms, 172 ms, 356 ms
