...
const responseTime = require("response-time"); // tilføjer headeren med hvor meget response tiden har været
const app = express();
...
app.get("/api/:n", function (req, res) {
  ...
  res.send(
    `Final count is ${count} by server running on port ${req.socket.localPort}`
  );
});
...
// loadtest http://localhost:8080/api/500000 -n 1000 -c 100
// loadtest http://localhost:8080/api/500000000 -n 1000 -c 100
