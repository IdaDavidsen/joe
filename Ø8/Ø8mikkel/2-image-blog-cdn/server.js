...
const multer = require("multer"); // til at arbejde med midlertidige filer
const fs = require("fs");
...
cloudinary.config({
  cloud_name: "dsmtpgfkg", // add your cloud_name
  api_key: "641272833579385", // add your api_key
  api_secret: "-P6M2cirnJr5WCMvu7wB1Wy5aDY", // add your api_secret
  secure: true,
});
